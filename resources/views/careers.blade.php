...
<body >
    ...
    <section>
        <div class="container">
            <h1>Careers</h1>
            <p>
                <b>EEC</b> Group is an “Employer of Choice” with a range of interesting and challenging opportunities that will
            ...
            <div class="row " id="results">
                @foreach($careers as $career)
                    <div class="col-md-4">
                        <div class="item">
                            <h3>{{$career->name}}</h3>
                            <p>{{$career->location->country}} </p>
                            <p>{{$career->category->name}}</p>
                            <a href="{{route('career.single',$career->id)}}">More Details...   <i class="now-ui-icons business_briefcase-24"></i></a>
